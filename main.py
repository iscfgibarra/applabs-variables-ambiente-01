...
def main():
    # Vienen de la configuracion de variables ya establecida en el sistema operativo
    ...
    # Vienen de la configuracion "artificial" creada por medio del archivo .env y load_env
